...
var searchResult=greet.search("ing");
console.log("Search Result: ", searchResult );

var sliceRsult=greet.slice(3, 15);
console.log("Slice Result: ", sliceRsult);

var greet="Good Morning Sagar, How are you";
var resultSplite=greet.split(" ");
console.log(resultSplite);
console.log("Total words in string: ", resultSplite.length);